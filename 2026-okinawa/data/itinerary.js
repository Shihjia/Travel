...
window.TRIP = {
  ...
  hotels: [
    {
      ...
      facilities: [
        ...
        {
          title: "室外花園泳池（ガーデンプール）",
          url: "https://kariyushi-oceanspa.jp/facility/",
          badges: [{ label: "房價已含，免費使用", tone: "pick" }, { label: "9:00-18:00", tone: "" }],
          rows: [
            "位於飯店中央的大型花園泳池，最深約1公尺，池底有緩坡設計，小孩也能使用",
            "2026年季節營業時間9:00-18:00（依官網2026年泳池方案公告查證，公告有效期至2026/10/31，涵蓋我們的入住期間）",
            "房價已含，房客可直接使用，不需另外購買日間泳池方案"
          ]
        },
        {
          title: "室內泳池（インドアプール）",
          url: "https://kariyushi-oceanspa.jp/facility/",
          badges: [{ label: "房價已含，免費使用", tone: "pick" }, { label: "9:00-22:00", tone: "" }],
          rows: [
            "25公尺室內泳池，位於ウイングタワーB1F，雨天或天氣不佳時的備案",
            "2026年季節營業時間9:00-22:00（同左，依官網2026年泳池方案公告查證，公告有效期至2026/10/31）",
            "房價已含，房客可直接使用"
          ]
        },
        {
      ...
      facilitiesNote: "⚠️海底漫步（シーウォーク，限小學生以上／¥9,900）、浮潛行程（スノーケルツアー，限6-59歲／¥5,500）、海上拖曳傘（パラセーリング，限滿10歲以上／¥9,900）三項因年齡限制小孩都不能玩，已從清單移除。チャイルドチューブ／水上摩托車／ドラゴンボート／水上樂園皆為現場當天報名，無法事先預約，建議當天早上先到海灘服務台（マリンカウンター）詢問排隊狀況。電話：0980-52-4093（8:30-17:30）。室外花園泳池／室內泳池兩項的營業時間是依2026-09-04查證官網公告的「2026年泳池＆午餐方案」內容確認（該公告本身是給一日遊訪客的付費方案，我們是住房客不需要另外付費參加，只是借用裡面揭露的2026年季節營業時間），公告有效期到2026/10/31，涵蓋我們的入住期間；這兩項卡片目前還沒有示意插圖，之後可以跟其他設施一起補上。",
      restaurants: [
        {
  ...
  /* 費用試算：日幣（包車／計程車／現場購票門票）與台幣（KLOOK 門票）分開計算，
     不做匯率換算、也不合併成單一總額 */
  costs: {
    intro: "Day1、Day4交通費用為日幣包車，向行腳沖繩訂購；Day2、Day5、Day6交通方式皆已定案改為計程車分段叫車，費用亦為日幣。美麗海水族館與沖繩世界（玉泉洞）門票會直接透過KLOOK購買，故以台幣列出；其餘景點門票（沖繩兒童王國）為官網現場購票金額，以日幣列出。日幣與台幣分開計算，不合併成單一總額。",
